...
public class AppWezer extends Application {
    @Override
    ...
    private void flyingDeep() {
        ...
        AppsFlyerLib.getInstance().init("EiKMJMjYZkkbzGjWY6aqkk", conversionListener, this); //todo вставить ключ апса
